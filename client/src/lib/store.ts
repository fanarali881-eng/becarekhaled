...
// Socket Configuration - reads from config.js (dynamic) first, then env var fallback
const SOCKET_URL = (window as any).__APP_CONFIG__?.SOCKET_URL || import.meta.env.VITE_SOCKET_URL || "http://localhost:3001";
